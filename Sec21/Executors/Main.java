...
import MultipleThreads.ThreadColor;
...
public class Main {
    ...
    public static void cachedmain(String[] args) {
        var multiExecutor = Executors.newCachedThreadPool();
        try{
            var redValue = multiExecutor.submit(()->Main.sum(1,10,1,"purple"));
    ...
    public static void fixed_main(String[] args) {
        
        int count = 6;
        var multiExecutor = Executors.newFixedThreadPool(3,
    ...
    public static void notmain(String[] args){
        ...
        Thread yellow = new Thread(
            Main::countDown,ThreadColor.ANSI_GREEN.name()
        );

        Thread red = new Thread(
            Main::countDown,ThreadColor.ANSI_CYAN.name()
        );
