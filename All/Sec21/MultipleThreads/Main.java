...
public class Main {
    public static void main(String[] args){
        ...
        Thread green = new Thread(greenWatch::countDown, ThreadColor.ANSI_CYAN.name());
        Thread purple = new Thread(()-> purpleWatch.countDown(7), ThreadColor.ANSI_GREEN.name());
        
        Thread red = new Thread(redWatch::countDown,ThreadColor.ANSI_BLUE.name());
